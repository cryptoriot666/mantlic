...
The Agent Registry contract is deployed at 0x59f18816D6F3E15f3a4B41c73810e7DDF50D1a1F on Mantle Sepolia. You can see the AgentRegistered events, the BenchmarkRecorded events, and the reputation updates all on the explorer.
...
Step 1: Open the Agent Registry on Mantle Sepolia Explorer. The direct link is sepolia.mantlescan.xyz/address/0x59f18816D6F3E15f3a4B41c73810e7DDF50D1a1F. Click the Contract tab to see the verified code. Click Txn Logs to see the on-chain events. This verifies 22 points.

Step 2: Open the Swap Contract on Mantle Sepolia Explorer. The direct link is sepolia.mantlescan.xyz/address/0x3B7FF2dDA45e9f4E323A6a049E366248468c2e78. Click Contract to see verified code. Click Txn Logs to see swap transactions. This verifies 15 points.

Step 3: Test the live app. Go to mantlic-2eecwgmju-the-riot-s-projects.vercel.app. Connect your MetaMask wallet (make sure you have Mantle Sepolia network configured). Type help to see all commands. Type balance to see your wallet. Type leaderboard to see agent rankings. This verifies the frontend works.
...
LIVE APP: mantlic-2eecwgmju-the-riot-s-projects.vercel.app
