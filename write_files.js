...
// Create directories
const dirs = [
  'C:/Users/nandacamp/mantlic/src/app/api/chat',
  'C:/Users/nandacamp/mantlic/src/app/api/mint'
];
dirs.forEach(d => fs.mkdirSync(d, { recursive: true }));

// File 1: chat route
const chatRoute = `import { OpenAI } from 'openai'
...
// File 2: mint route
const mintRoute = `import { NextRequest, NextResponse } from 'next/server'
...
// Write files
fs.writeFileSync('C:/Users/nandacamp/mantlic/src/app/api/chat/route.ts', chatRoute);
console.log('Written: src/app/api/chat/route.ts');

fs.writeFileSync('C:/Users/nandacamp/mantlic/src/app/api/mint/route.ts', mintRoute);
console.log('Written: src/app/api/mint/route.ts');

fs.writeFileSync('C:/Users/nandacamp/mantlic/src/components/AgentCard.tsx', agentCard);
console.log('Written: src/components/AgentCard.tsx');

fs.writeFileSync('C:/Users/nandacamp/mantlic/.env.example', envExample);
console.log('Written: .env.example');
