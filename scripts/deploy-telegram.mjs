#!/usr/bin/env node
/**
 * Mantlic Telegram Bot - Single File Deployment Ready
 * No dependencies. No build step.
 * Usage: TELEGRAM_BOT_TOKEN=*** node scripts/deploy-telegram.mjs
 */
...
if (!TELEGRAM_TOKEN) {
  ...
  console.error('Usage: TELEGRAM_BOT_TOKEN=*** node scripts/deploy-telegram.mjs');
  process.exit(1);
}
